...
homeBanner
    ...
    .from(" .banner .bl-left .v-line ", { duration: 0.8, alpha: 0, height: 0, ease: "power1.out()" }, "-=.7")
    .from(" .banner .bl-right .anim", { duration: 0.8, alpha: 0, stagger: 0.2, x: 100, ease: "back.out(1.5)" }, "-=.5");
...
detailS1
    ...
    .from(" .detail .s1 .v-line", { duration: 0.8, height: 0, ease: "power1.out()" }, "-=.5");
...
story
    ...
    .from(" .story .s2 .v-line", { duration: 0.8, height: 0, ease: "power1.out()" }, "-=.5");
...
contact
    ...
    .from(" .contact .bl-right .img", { duration: 0.8, scale: 0.8, alpha: 0, ease: "back.out(2)" }, "-=.5")
    .from(" .contact .s2 .v-line", { duration: 0.8, height: 0, ease: "power1.out()" }, "-=.5");
